...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            // ==========================================
            // 1. USER (Gestion intelligente pour éviter Duplicate Entry)
            // ==========================================
            ...
            if (dbUser == null) {
                ...
                System.out.println("✅ Utilisateur 'maissa' ajouté !");
            } else {
                System.out.println("ℹ️ Utilisation de l'utilisateur existant : " + dbUser.getEmail());
            }
