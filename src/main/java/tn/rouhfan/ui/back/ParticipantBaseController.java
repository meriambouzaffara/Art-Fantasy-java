...
public class ParticipantBaseController {
    ...
    public void initialize() {
        ...
        if (!SessionManager.getInstance().checkAccess("ROLE_PARTICIPANT")) {
            javafx.application.Platform.runLater(() -> {
                ...
                alert.setContentText("⛔ Vous devez être participant pour accéder à cette page.");
                alert.showAndWait();
